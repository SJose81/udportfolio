...
-> Added print media query for print.css stylesheet link to reduce render blocking
-> Used 'Async' attribute to external scripts to optimize javascript
-> Used 'defer' in inline google analytics script to optimize and execute the script only once the page has loaded.
-> Two Code fixes made to main.js to eleminate Jank:
